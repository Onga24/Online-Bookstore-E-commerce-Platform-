...
// --- CORS Configuration ---
// IMPORTANT: Update 'origin' to match your Angular frontend's URL (e.g., http://localhost:4200)
// For production, this should be your actual domain (e.g., 'https://your-frontend-domain.com')
app.use(cors({
  origin: 'http://localhost:4200' // Set to Angular's default development port
}));
